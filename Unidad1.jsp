...
<script src="https://code.highcharts.com/modules/exporting.js"></script>
    ...
    <body >
        ...
        <section>
         <div id="presentacion">
         <div id="resp"> 
            <center> <h1>Evaluación 1</h1></center>
            <div > <br>
                    ...
                    <%!       
                                ...
                                {   
                                    ...
                                    salida +="<label  class='pregunta'>"+question[i]+"</label>"+ 
                                                        ...
                                                        "<label class='observacion' id='dans"+i+"'  style='display: none;'> La respuesta es:<h3>"+answers[4]+"</h3></label> <br> <br>"
                                                        ;
                                    }
                                     return salida;
                                }
                        ...
                        <div id="select-custom" > 
                            <%=questionary(request.getRealPath("/")+"Archivos\\Preguntas1.txt",request.getRealPath("/")+"Archivos\\Respuestas1.txt")%>
                        </div>
                         <br><br><br>
